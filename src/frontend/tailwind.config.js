  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "3d-sm": "0 4px 0 oklch(0.45 0.18 25), 0 6px 16px rgba(0,0,0,0.15)",
        "3d-md": "0 6px 0 oklch(0.40 0.18 22), 0 10px 24px rgba(0,0,0,0.18)",
        "3d-lg": "0 8px 0 oklch(0.35 0.16 20), 0 16px 40px rgba(0,0,0,0.22)",
