const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ThreeOrganizer-exkBm905.js","assets/index-gyxfEToW.js","assets/index-ng442YZw.css"])))=>i.map(i=>d[i]);
import { r as reactExports, j as jsxRuntimeExports, R as React, _ as __vitePreload } from "./index-gyxfEToW.js";
/**
...
const Anchor = createLucideIcon("anchor", __iconNode$m);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Bath = createLucideIcon("bath", __iconNode$l);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const ChefHat = createLucideIcon("chef-hat", __iconNode$k);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function FeatureCard({
  ...
  const Icon2 = ICON_MAP[icon] ?? Sparkles;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground text-lg mb-2 leading-snug", children: title }),
...
function GuaranteeBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, oklch(0.58 0.24 26) 0%, oklch(0.50 0.22 22) 60%, oklch(0.44 0.20 20) 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-6xl mx-auto px-4 sm:px-6", children: [
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "We stand behind every PESOMA product. If anything goes wrong within 3 years, we make it right — no questions asked."
                }
              )
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: TRUST_POINTS.map((point, i) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        className: `sticky top-0 z-50 transition-smooth ${scrolled ? "bg-card shadow-3d-sm border-b border-border" : "bg-card border-b border-border/50"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 sm:h-18", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-md gradient-shine flex items-center justify-center shadow-3d-sm group-hover:shadow-3d-md transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-display font-bold text-sm", children: "HE" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex flex-col leading-tight", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground text-sm tracking-tight", children: "Home Essentials" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: "homeessentials.in" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-foreground text-base sm:text-lg tracking-tight", children: "PESOMA Organizer" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              showCartCTA && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: cartLink,
                  target: "_blank",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "btn-3d-orange w-full font-semibold flex items-center justify-center gap-2 py-3 rounded-lg mt-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "w-4 h-4" }),
                      "Add to Cart — Shop Now"
                    ] })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "mt-3 flex flex-col gap-1", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-6xl mx-auto px-4 sm:px-6 py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-md gradient-shine flex items-center justify-center shadow-3d-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white font-display font-bold text-sm", children: "HE" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm", children: "Home Essentials" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: "https://homeessentials.in",
                  ...
                  children: "homeessentials.in"
                }
              )
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center sm:text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
            "© ",
  ...
  features: [
    {
      ...
      description: "Adjusts from 38cm to 65cm to fit virtually any cabinet or under-sink space without cutting or drilling."
    },
    {
      icon: "Layers",
      title: "2-Tier Storage",
      description: "Double-deck design doubles your usable space — top shelf for bottles, lower tier for bulkier items."
    },
    {
      icon: "Shield",
      title: "Carbon Steel Frame",
      description: "Rust-resistant carbon stainless steel construction supports up to 15 kg across both tiers."
    },
    {
      icon: "Grid3x3",
      title: "Removable Panels",
      description: "Side panels and dividers detach in seconds for custom configurations and easy deep cleaning."
    },
    {
      icon: "Hook",
      title: "Integrated Hooks",
      description: "Built-in hanging hooks on the side panels for sponges, mitts, spray bottles, and more."
    },
    {
      icon: "Sparkles",
      title: "No-Scratch Feet",
      description: "Rubberized non-slip feet protect cabinet floors and keep the organizer perfectly stable."
    }
  ],
  specs: [
...
const ThreeOrganizer = reactExports.lazy(
  () => __vitePreload(() => import("./ThreeOrganizer-exkBm905.js"), true ? __vite__mapDeps([0,1,2]) : void 0).then((m) => ({
...
const AMAZON_LINK = "https://www.amazon.in/PESOMA-Organizer-Adjustable-Expandable-Professional/dp/B0G4468CBL";
function ProductPage() {
  const product = PESOMA_PRODUCT;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { cartLink: AMAZON_LINK, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          background: "linear-gradient(160deg, oklch(0.14 0.03 22) 0%, oklch(0.18 0.025 30) 50%, oklch(0.12 0.04 20) 100%)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(ellipse 80% 60% at 60% 40%, oklch(0.62 0.22 29 / 0.12) 0%, transparent 70%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-6xl mx-auto px-4 sm:px-6 flex-1 flex flex-col lg:flex-row items-center gap-10 py-16 lg:py-20 relative z-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col items-center lg:items-start text-center lg:text-left min-w-0 order-2 lg:order-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  initial: { scale: 0.7, opacity: 0 },
                  ...
                  style: {
                    background: "linear-gradient(90deg, oklch(0.65 0.22 32) 0%, oklch(0.56 0.24 24) 100%)",
                    color: "oklch(1.0 0 0)",
                    boxShadow: "0 0 0 3px oklch(0.62 0.22 29 / 0.3), 0 8px 20px oklch(0.62 0.22 29 / 0.4)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "🛡️" }),
                    "3 YEAR GUARANTEE — BACKED BY HOME ESSENTIALS"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.h1,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ...
                      {
                        style: {
                          background: "linear-gradient(90deg, oklch(0.75 0.22 36) 0%, oklch(0.62 0.22 29) 100%)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.p,
                {
                  ...
                  children: "2-Tier Expandable Cabinet Shelf Organizer"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.p,
                {
                  ...
                  children: "Adjustable 38–65 cm width, rust-proof carbon steel frame, no tools required. Reclaim your cabinet space in minutes."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5", children: [1, 2, 3, 4, 5].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Star,
                      {
                        className: "w-4 h-4",
                        style: {
                          fill: n <= 4 ? "oklch(0.72 0.18 55)" : "oklch(0.72 0.18 55 / 0.5)",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#features", "data-ocid": "hero.explore_link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Button,
                      {
                        variant: "ghost",
                        size: "lg",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: USES.map(({ label, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
              ...
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ...
                    {
                      fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex items-center justify-center min-h-[340px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-full rounded-3xl" }) }),
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThreeOrganizer, {})
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "p",
                    {
                      ...
                      children: "Drag to rotate · Interactive 3D view"
                    }
                  )
                ]
              }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(GuaranteeBanner, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        id: "features",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl sm:text-4xl md:text-5xl text-foreground mb-4", children: "Why Choose PESOMA?" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground max-w-xl mx-auto text-base sm:text-lg", children: "Every detail engineered to last — from the rust-proof frame to the snap-fit dividers." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: product.features.map((feature, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            FeatureCard,
            {
              icon: feature.icon,
              title: feature.title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl sm:text-4xl text-foreground mb-4", children: "Product Specifications" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-semibold text-foreground flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { className: "w-4 h-4 text-accent-orange" }),
                    "Technical Details"
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: product.specs.map((spec, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      "data-ocid": `specs.row.${i + 1}`,
                      className: "flex items-center justify-between px-6 py-3.5",
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-medium", children: spec.label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground font-semibold tabular-nums", children: spec.value })
                      ]
                    },
                    spec.label
                  )) })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4 text-sm uppercase tracking-widest", children: "Perfect For" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: USES.map(({ label, icon: Icon2 }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      motion.span,
                      {
                        ...
                        style: {
                          background: "linear-gradient(135deg, oklch(0.65 0.22 32 / 0.12) 0%, oklch(0.58 0.24 26 / 0.08) 100%)",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { "data-ocid": "cta.section", className: "section-dark py-16 sm:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-3xl mx-auto px-4 sm:px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 24 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: "🛡️ 3-Year Manufacturer's Guarantee Included"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h2",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "oklch(0.6 0.015 22)" },
              children: "Join 2,800+ happy customers. Ships directly from Amazon India with fast delivery."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-6 mt-10", children: TRUST_ROW.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Sold & fulfilled by PESOMA on Amazon.in · Prices and availability may vary"
            }
          )
        ]
      }
